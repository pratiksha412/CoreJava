...
public class CompareToExample {
	...
	public static void main(String[] args) {
		...
		arrayList.add(new EmployeeData(1, "Pratiksha", LocalDate.of(2024, 12, 15), "Developer"));
		arrayList.add(new EmployeeData(1, "Nachiket", LocalDate.of(2022, 02, 13), "Developer"));
		arrayList.add(new EmployeeData(1, "Devika", LocalDate.of(2020, 11, 10), "Developer"));
		arrayList.add(new EmployeeData(1, "Parth", LocalDate.of(2019, 8, 03), "Developer"));
